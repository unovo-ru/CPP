...
int main()
{
	...
	/*se demuestra que todo funciona exactamente igual:
	Animal no se puede instanciar directamente, lo hemos impedido con el (=0)
	
	Sin embargo Dog y Cat siguen pudiendo instanciarse y funcionan de la misma
	sin cambios ni errores inesperados, esto se debe a que Animal siempre
	se entendio como una clase plantilla con caracteristicas para crear objetos nuevos
	pero sin utilidad unica en si misma*/
